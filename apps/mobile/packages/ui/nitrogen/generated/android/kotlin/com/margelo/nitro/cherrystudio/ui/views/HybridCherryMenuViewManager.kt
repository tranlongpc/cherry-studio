///
/// HybridCherryMenuViewManager.kt
...
/**
 * Represents the React Native `ViewManager` for the "CherryMenuView" Nitro HybridView.
 */
public class HybridCherryMenuViewManager: SimpleViewManager<View>() {
  init {
    if (RecyclableView::class.java.isAssignableFrom(HybridCherryMenuView::class.java)) {
  ...
  private fun getHybridView(view: View): HybridCherryMenuView? {
    return view.getTag(associated_hybrid_view_tag) as? HybridCherryMenuView
  }
}
